...
-- - hr_manager_role_setup.sql (HR Manager role schema validation and data migration)
-- - create_hr_manager_account.sql (HR Manager account creation)
-- 
-- Instructions:
...
-- ========================================
-- HR MANAGER ROLE SETUP (Schema Validation)
-- ========================================
-- This section ensures the user_account table has the role column
